    ...
    , ui(new Ui::Widget)
{
    ...
    connect(ui->pushButton, &QPushButton::clicked, [&](){
        QString filename = QFileDialog::getOpenFileName(this, "打开文件", "/home/yin-roc/1_Code/Ubuntu20.04/Qt_Project_Code/Qt_learning_demo/41_Fileinfo/File");
...
//        QByteArray array = file.readAll(); // 读取全部内容
    ...
    QFile file("/home/yin-roc/1_Code/Ubuntu20.04/Qt_Project_Code/Qt_learning_demo/41_Fileinfo/File/Mytest.txt");
    QFileInfo info(file);
