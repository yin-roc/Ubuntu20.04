...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        toolButton->setGeometry(QRect(290, 170, 101, 61));
        toolButton->setIconSize(QSize(32, 32));
        toolButton->setToolButtonStyle(Qt::ToolButtonTextBesideIcon);
        toolButton->setAutoRaise(true);
        groupBox = new QGroupBox(Widget);
        groupBox->setObjectName(QString::fromUtf8("groupBox"));
        groupBox->setGeometry(QRect(70, 250, 161, 151));
        radioButton_3 = new QRadioButton(groupBox);
        radioButton_3->setObjectName(QString::fromUtf8("radioButton_3"));
        radioButton_3->setGeometry(QRect(10, 90, 112, 23));
        radioButton_2 = new QRadioButton(groupBox);
        radioButton_2->setObjectName(QString::fromUtf8("radioButton_2"));
        radioButton_2->setGeometry(QRect(10, 60, 112, 23));
        radioButton = new QRadioButton(groupBox);
        radioButton->setObjectName(QString::fromUtf8("radioButton"));
        radioButton->setGeometry(QRect(10, 20, 151, 41));
        groupBox_2 = new QGroupBox(Widget);
        groupBox_2->setObjectName(QString::fromUtf8("groupBox_2"));
        groupBox_2->setGeometry(QRect(270, 250, 161, 221));
        ...
        groupBox_3->setGeometry(QRect(510, 250, 191, 221));
        ...
        checkBox_2->setGeometry(QRect(10, 60, 92, 23));
        checkBox_3 = new QCheckBox(groupBox_3);
        checkBox_3->setObjectName(QString::fromUtf8("checkBox_3"));
        checkBox_3->setGeometry(QRect(10, 90, 92, 23));
        checkBox_4 = new QCheckBox(groupBox_3);
        checkBox_4->setObjectName(QString::fromUtf8("checkBox_4"));
        checkBox_4->setGeometry(QRect(10, 120, 92, 23));
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        checkBox->setText(QCoreApplication::translate("Widget", "\344\272\272\345\270\205", nullptr));
        checkBox_2->setText(QCoreApplication::translate("Widget", "\346\200\235\350\267\257\346\270\205\346\231\260", nullptr));
        checkBox_3->setText(QCoreApplication::translate("Widget", "\344\273\243\347\240\201\347\256\200\346\264\201", nullptr));
        checkBox_4->setText(QCoreApplication::translate("Widget", "\345\217\243\351\275\277\346\270\205\346\231\260", nullptr));
    } // retranslateUi
